...
<svg width="400" height="120" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <!-- Spotify Logo -->
    <image x="365" y="15" width="20" height="20" xlink:href="data:image/png;base64," />
</svg>
"""
    return svg.strip()
...
def update_readme(track, is_playing):
    ...
    # 2. Atualizar README
    # Apenas garantimos que o README tenha o link para a imagem SVG
    new_content = f"""
